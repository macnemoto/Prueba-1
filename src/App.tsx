  ...
  return (
    <div className=' bg-gradient-to-r from-green-400 to-teal-500 h-screen'>
      <div className=' flex flex-col justify-center items-center px-4'>
        <img className='w-64 my-3 rounded-lg' src="/img/Captura de pantalla 2024-02-26 140801.png" alt="Pokémon Bulbasaur Card" />
      ...
      <div className='flex justify-center items-center w-full px-4 mt-5 pb-4  '>
        <div className='flex items-center justify-between w-full md:w-1/2 lg:w-2/5 xl:w-1/3 2xl:w-1/4 px-4 '>
          <div className='flex flex-row'>
            <img className='w-6 h-6 mt-1 mx-1' src="/img/Energ%3Fa_planta.webp" alt="planta verde" />
            <img className='w-6 h-6 mt-1 mx-1' src="/img/Energ%3Fa_incolora.webp" alt="planta verde" />
          ...
          <div className='grid grid-cols-3 gap-4 bg-gray-300 w-full text-sm text-gray-800 rounded-t-lg px-4 pt-2'>
            <div className=''>
              ...
              <div className='flex flex-row pt-3 self-end'>
                <img className='w-6 h-6 mt-1 mx-1' src="/img/Energ%3Fa_fuego.webp" alt="planta verde" />
            ...
            <div>Coste de Retirada
              <div className='flex flex-row pt-3'>
                <img className='w-6 h-6 mt-1 mx-1' src="/img/Energ%3Fa_incolora.webp" alt="planta incoloro" />
                <img className='w-6 h-6 mt-1 mx-1' src="/img/Energ%3Fa_incolora.webp" alt="planta incoloro" />
              </div>
            </div>
          </div>
