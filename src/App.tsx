...
function App () {
  ...
  useEffect(() => {
    fetch('https://api.pokemontcg.io/v2/cards/dp3-77', {
      headers: {
  ...
  return (
    <main className='flex flex-col lg:flex-row justify-center items-center lg:items-start'>
        <img className='w-64 my-3 rounded-lg' src={card?.data.images.large} alt="Pokémon Bulbasaur Card" />
      <section className=' flex flex-col items-center justify-between w-full font-semibold md:w-[560px] px-4 lg:mt-3'>
