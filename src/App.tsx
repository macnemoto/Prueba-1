...
function App () {
  ...
  useEffect(() => {
    fetch('https://api.pokemontcg.io/v2/cards/swsh12pt5gg-GG32', {
      headers: {
  ...
  return (
    <main className='flex flex-col lg:flex-row justify-center items-center lg:items-start lg:py-10'>
      <div className=' flex lg: flex-col justify-center items-center px-10 lg:w-2/4'>
        <img className='h-auto w-80  my-2 rounded-lg' src={card?.data.images.large} alt="Pokémon Bulbasaur Card" />
